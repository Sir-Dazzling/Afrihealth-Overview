...
const NavBar = () => {
    ...
    return (
        ...
        px-2 md:px-10 lg:px-10 py-5 font-visblyround`}>
                <Link href="/">
                    <img
                        src="/images/logo.png"
            ...
            {openNav && <div
                className="bg-gray-100 h-screen top-0 bottom-0 absolute z-10 left-1/2 transform -translate-x-1/2 px-2 w-screen sm:px-0 flex justify-between font-visblyround">

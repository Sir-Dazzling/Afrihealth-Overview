...
const PolarisSection = () => {
    return (
        <div className="bg-white flex flex-col space-y-0 lg:space-y-0 justify-between px-3 md:px-10 lg:px-12 py-5 lg:py-10 my-5 lg:my-10 text-black lg:mx-32 rounded-xl">

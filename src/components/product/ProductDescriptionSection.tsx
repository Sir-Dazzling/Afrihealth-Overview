...
const ProductDescriptionSection = () => {
    return (
        <div className="bg-purple-normal flex flex-col space-y-0 lg:space-y-0 justify-between px-2 md:px-10 pt-5 lg:px-12 lg:pt-10 text-white lg:mx-10 rounded-xl font-visblyround">
